      ...
      <div className="max-w-4xl mx-auto text-center relative z-10 flex flex-col items-center">
        ...
        <div className="mt-4 pt-8 border-t border-[#E5E1D8]/10 w-full max-w-md flex flex-col items-center">
          <span className="text-[9px] uppercase tracking-[0.3em] text-[#C5A059] font-bold mb-2">
            Invitaciones Virtuales & Diseño Gráfico
          </span>
          <p className="font-serif text-sm text-gray-300 tracking-wide font-light mb-5">
            Creado con amor por <span className="text-white hover:text-[#D4AF37] transition-colors font-normal">VAC Creative</span>
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-2.5">
            ...
            <a
              href="https://wa.me/51932350348?text=Hola!%20Vi%20el%20hermoso%20diseño%20de%20la%20invitación%20de%20bodas%20y%20me%20gustaría%20cotizar%20una%20invitación%20virtual%20o%20servicios%20de%20diseño%20gráfico."
              target="_blank"
